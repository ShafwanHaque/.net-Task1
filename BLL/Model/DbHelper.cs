    ...
    public class DbHelper
    {
        ...
        public void SaveStudent(StudentModel studentModel)
        {
            if (studentModel.S_Id > 0)
            {
                ...
                var existingStudent = _context.Students.FirstOrDefault(s => s.S_Id == studentModel.S_Id);
            ...
            else
            {
                ...
                _context.SaveChanges(); // Save changes to get the actual ID generated by the database
                studentModel.S_Id = newStudent.S_Id; // Update the studentModel with the actual ID
            }

            _context.SaveChanges(); // Save changes for updates
        }
